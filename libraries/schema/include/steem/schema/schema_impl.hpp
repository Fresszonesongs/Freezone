...
#define freezone_DECLARE_SCHEMA_CLASS( is_reflected, is_enum )  \
template< typename ObjectType >                                 \
struct schema_impl< ObjectType, is_reflected, is_enum >         \
   : public abstract_schema                                     \
{                                                               \
freezone_SCHEMA_TEMPLATE_CLASS_BODY( schema_impl )              \
};

// Templated version of macro includes some method definitions
#define freezone_SCHEMA_TEMPLATE_CLASS_BODY( CLASSNAME )        \
...
#define freezone_SCHEMA_CLASS_BODY( CLASSNAME )                 \
...
#define freezone_SCHEMA_DEFINE_CLASS_METHODS( CLASSNAME )       \
...
freezone_DECLARE_SCHEMA_CLASS( false, false )
freezone_DECLARE_SCHEMA_CLASS(  true, false )
freezone_DECLARE_SCHEMA_CLASS(  true,  true )
