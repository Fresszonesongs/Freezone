 ...
 * - Length is between (inclusive) freezone_MIN_ACCOUNT_NAME_LENGTH and freezone_MAX_ACCOUNT_NAME_LENGTH
 */
bool is_valid_account_name( const string& name );

bool operator == ( const authority& a, const authority& b );

} } // namespace freezone::protocol


FC_REFLECT_TYPENAME( freezone::protocol::authority::account_authority_map)
FC_REFLECT_TYPENAME( freezone::protocol::authority::key_authority_map)
FC_REFLECT( freezone::protocol::authority, (weight_threshold)(account_auths)(key_auths) )
FC_REFLECT_ENUM( freezone::protocol::authority::classification, (owner)(active)(key)(posting) )
