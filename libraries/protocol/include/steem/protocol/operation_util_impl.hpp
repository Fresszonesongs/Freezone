...
//
// Place freezone_DEFINE_OPERATION_TYPE in a .cpp file to define
// functions related to your operation type
//
#define freezone_DEFINE_OPERATION_TYPE( OperationType )                       \
                                                                           \
namespace freezone { namespace protocol {                                     \
                                                                           \
void operation_validate( const OperationType& op )                         \
{                                                                          \
   op.visit( freezone::protocol::operation_validate_visitor() );              \
}                                                                          \
                                                                           \
...
{                                                                          \
   op.visit( freezone::protocol::get_required_auth_visitor( active, owner, posting, other ) ); \
}                                                                          \
                                                                           \
} } /* freezone::protocol */
