...
namespace detail
{
   ...
   {
      public:
         blockchain_statistics_api_impl( freezone::app::application& app )
            :_app( app ) {}
   ...
   statistics blockchain_statistics_api_impl::get_stats_for_interval( fc::time_point_sec start, fc::time_point_sec end )const
   {
      ...
      const auto& sizes = _app.get_plugin< blockchain_statistics_plugin >( freezone_BLOCKCHAIN_STATISTICS_PLUGIN_NAME )->get_tracked_buckets();
...
blockchain_statistics_api::blockchain_statistics_api( const freezone::app::api_context& ctx )
{
...
statistics& statistics::operator +=( const bucket_object& b )
{
   ...
   this->freezone_transferred                      += b.freezone_transferred;
   ...
   this->freezone_vested                           += b.freezone_vested;
   ...
   this->freezone_converted                        += b.freezone_converted;
