...
#include <freezone/blockchain_statistics/blockchain_statistics_plugin.hpp>
...
{
   public:
      blockchain_statistics_api( const freezone::app::api_context& ctx );
...
FC_REFLECT( freezone::blockchain_statistics::statistics,
   (blocks)
   (bandwidth)
   (operations)
   (transactions)
...
FC_API( freezone::blockchain_statistics::blockchain_statistics_api,
   (get_stats_for_time)
