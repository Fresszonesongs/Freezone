...
// time.
//
#ifndef freezone_BLOCKCHAIN_STATISTICS_SPACE_ID
#define freezone_BLOCKCHAIN_STATISTICS_SPACE_ID 9
#endif

#ifndef freezone_BLOCKCHAIN_STATISTICS_PLUGIN_NAME
#define freezone_BLOCKCHAIN_STATISTICS_PLUGIN_NAME "chain_stats"
#endif

namespace freezone { namespace blockchain_statistics {
...
{
   bucket_object_type = ( freezone_BLOCKCHAIN_STATISTICS_SPACE_ID << 8 )
};
...
class blockchain_statistics_plugin : public freezone::app::plugin
{
   public:
      blockchain_statistics_plugin( application* app );
      virtual ~blockchain_statistics_plugin();

      virtual std::string plugin_name()const override { return freezone_BLOCKCHAIN_STATISTICS_PLUGIN_NAME; }
...
struct bucket_object : public object< bucket_object_type, bucket_object >
{
   ...
   share_type           freezone_transferred = 0;                       ///< freezone transferred from account to account
   ...
   share_type           liquidity_rewards_paid = 0;                  ///< Ammount of freezone paid to market makers
   uint32_t             transfers_to_vesting = 0;                    ///< Transfers of freezone into VESTS
   share_type           freezone_vested = 0;                            ///< Ammount of freezone vested
   ...
   share_type           vests_withdrawn = 0;                         ///< Ammount of VESTS withdrawn to freezone
...
} } // freezone::blockchain_statistics

FC_REFLECT( freezone::blockchain_statistics::bucket_object,
   (id)
   (open)
   (seconds)
   (blocks)
...
CHAINBASE_SET_INDEX_TYPE( freezone::blockchain_statistics::bucket_object, freezone::blockchain_statistics::bucket_index )
