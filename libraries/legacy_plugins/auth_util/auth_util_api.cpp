...
#include <freezone/protocol/sign_state.hpp>

#include <freezone/chain/account_object.hpp>
#include <freezone/chain/database.hpp>

#include <freezone/plugins/auth_util/auth_util_api.hpp>
#include <freezone/plugins/auth_util/auth_util_plugin.hpp>
...
{
   public:
      auth_util_api_impl( freezone::app::application& _app );
      void check_authority_signature( const check_authority_signature_params& args, check_authority_signature_result& result );

      std::shared_ptr< freezone::plugin::auth_util::auth_util_plugin > get_plugin();

      freezone::app::application& app;
};

auth_util_api_impl::auth_util_api_impl( freezone::app::application& _app ) : app( _app )
{}

std::shared_ptr< freezone::plugin::auth_util::auth_util_plugin > auth_util_api_impl::get_plugin()
{
...
auth_util_api::auth_util_api( const freezone::app::api_context& ctx )
{
