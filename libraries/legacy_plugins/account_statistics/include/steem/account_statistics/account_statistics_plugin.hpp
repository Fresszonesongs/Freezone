...
// time.
//
#ifndef freezone_ACCOUNT_STATISTICS_SPACE_ID
#define freezone_ACCOUNT_STATISTICS_SPACE_ID 10
#endif

#ifndef freezone_ACCOUNT_STATISTICS_PLUGIN_NAME
#define freezone_ACCOUNT_STATISTICS_PLUGIN_NAME "account_stats"
#endif
...
{
   account_stats_bucket_object_type    = ( freezone_ACCOUNT_STATISTICS_SPACE_ID << 8 ),
   account_activity_bucket_object_type = ( freezone_ACCOUNT_STATISTICS_SPACE_ID << 8 ) + 1
};
...
struct account_stats_bucket_object : public object< account_stats_bucket_object_type, account_stats_bucket_object >
{
   ...
   share_type           author_rewards_total_freezone_value = 0;     ///< freezone Value of author rewards
   ...
   share_type           curation_rewards_freezone_value = 0;         ///< freezone Value of curation rewards
   ...
   share_type           liquidity_rewards = 0;                    ///< Amount of freezone paid as liquidity rewards
   ...
   share_type           freezone_sent = 0;                           ///< freezone sent from this account
   share_type           freezone_received = 0;                       ///< freezone received by this account
   ...
   share_type           freezone_vested = 0;                         ///< freezone vested by the account
   ...
   share_type           freezone_received_from_withdrawls = 0;       ///< freezone received from this account's vesting withdrawals
   share_type           freezone_received_from_routes = 0;           ///< freezone received from another account's vesting withdrawals
   ...
   share_type           freezone_converted = 0;                      ///< Amount of freezone that was converted
   ...
   share_type           limit_order_freezone_paid = 0;               ///< freezone paid by limit orders
   share_type           limit_order_freezone_received = 0;           ///< freezone received from limit orders
...
class account_statistics_plugin : public freezone::app::plugin
{
   public:
      account_statistics_plugin( application* app );
      virtual ~account_statistics_plugin();

      virtual std::string plugin_name()const override { return freezone_ACCOUNT_STATISTICS_PLUGIN_NAME; }
...
FC_REFLECT( freezone::account_statistics::account_stats_bucket_object,
   (id)
   (open)
   (seconds)
   (name)
   ...
   (vests_withdrawn)
   (freezone_received_from_withdrawls)
   (freezone_received_from_routes)
   ...
   (limit_order_freezone_paid)
   (limit_order_freezone_received)
   (limit_order_sbd_paid)
   (limit_order_sbd_received)
   (total_pow)
   (estimated_hashpower)
)
//SET_INDEX_TYPE( freezone::account_statistics::account_stats_bucket_object,)

FC_REFLECT(
   freezone::account_statistics::account_activity_bucket_object,
   (id)
   (open)
   (seconds)
