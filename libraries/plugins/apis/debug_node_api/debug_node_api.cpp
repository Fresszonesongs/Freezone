#include <freezone/plugins/debug_node_api/debug_node_api_plugin.hpp>
#include <freezone/plugins/debug_node_api/debug_node_api.hpp>
...
{
   if( args.hardfork_id > freezone_NUM_HARDFORKS )
      return {};
...
{
   JSON_RPC_REGISTER_API( freezone_DEBUG_NODE_API_PLUGIN_NAME );
}
