#include <freezone/plugins/chain_api/chain_api_plugin.hpp>
#include <freezone/plugins/chain_api/chain_api.hpp>
...
{
   JSON_RPC_REGISTER_API( freezone_CHAIN_API_PLUGIN_NAME );
}
