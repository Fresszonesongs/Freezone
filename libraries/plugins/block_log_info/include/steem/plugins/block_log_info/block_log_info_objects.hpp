...
#ifndef freezone_BLOCK_LOG_INFO_SPACE_ID
#define freezone_BLOCK_LOG_INFO_SPACE_ID 14
#endif

enum block_log_info_object_types
{
   block_log_hash_state_object_type      = ( freezone_BLOCK_LOG_INFO_SPACE_ID << 8 )    ,
   block_log_pending_message_object_type = ( freezone_BLOCK_LOG_INFO_SPACE_ID << 8 ) + 1,
};
...
FC_REFLECT( freezone::plugins::block_log_info::block_log_hash_state_object, (id)(total_size)(rsha256)(last_interval) )
CHAINBASE_SET_INDEX_TYPE( freezone::plugins::block_log_info::block_log_hash_state_object, freezone::plugins::block_log_info::block_log_hash_state_index )

FC_REFLECT( freezone::plugins::block_log_info::block_log_message_data, (block_num)(total_size)(current_interval)(rsha256) )

FC_REFLECT( freezone::plugins::block_log_info::block_log_pending_message_object, (id)(data) )
CHAINBASE_SET_INDEX_TYPE( freezone::plugins::block_log_info::block_log_pending_message_object, freezone::plugins::block_log_info::block_log_pending_message_index )
