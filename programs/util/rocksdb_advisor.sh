...
while (( "$#" )); do
   case "$1" in
      ...
      -p|--stats-dump-period)
         ...
         ;;
      -h|--help)
         echo "Specify data directory with '--data-dir' (Default is ~/.freezoned)"
         echo "Specify freezoned directory with '--freezoned-dir' (Default is ../..)"
...
cd "$freezoneD_DIR/libraries/vendor/rocksdb/tools/advisor"
