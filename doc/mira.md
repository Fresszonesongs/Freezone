...
When configuring MIRA it is important to consider the normal memory usage of `freezoned`. Regardless of the MIRA configuration, `freezoned` will tend to use roughly 5.5GiB of memory.
