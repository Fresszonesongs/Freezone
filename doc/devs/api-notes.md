...
The freezone developers recommend using the first of these methods to secure the API by binding to localhost, as follows:
...
The `freezoned` process includes username/password based authentication to individual APIs.
