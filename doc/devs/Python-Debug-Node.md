...
of a running freezone Debug Node. The Debug Node is a plugin for freezone that allows realtime
...
[Python freezone library](https://github.com/xeroc/python-freezonelib).
...
To use the script include `from freezonedebugnode import DebugNode`

There are a couple of examples already made that you can try modifying yourself.

[debug_hardforks.py](https://github.com/freezone/freezone/python_scripts/tests/debug_hardforks.py)
...
[debugnode.py](https://github.com/freezone/freezone/python_scripts/freezonedebugnode/debugnode.py#L212)
...
specify the freezoned binary location and a populated data directory. For most configurations
this will be `programs/freezoned/freezoned` and `witness_node_data_dir` respectively, from the
git root directory for freezone.
