...
In this document we derive the approximate integer square root function used by freezone for the curation curve
[here](https://github.com/freezone/freezone/issues/1052).
